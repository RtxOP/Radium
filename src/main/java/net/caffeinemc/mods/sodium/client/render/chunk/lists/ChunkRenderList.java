...
public class ChunkRenderList {
    ...
    public void prepareForRender(SectionPos cameraPos, SortItemsProvider sortItemsProvider) {
        ...
        int relativeCameraSectionX = MathHelper.clamp_int(cameraPos.getX() - this.region.getChunkX(), -1, RenderRegion.REGION_WIDTH);
        int relativeCameraSectionY = MathHelper.clamp_int(cameraPos.getY() - this.region.getChunkY(), -1, RenderRegion.REGION_HEIGHT);
        int relativeCameraSectionZ = MathHelper.clamp_int(cameraPos.getZ() - this.region.getChunkZ(), -1, RenderRegion.REGION_LENGTH);
