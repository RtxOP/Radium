...
public class DefaultShaderInterface implements ChunkShaderInterface {
    ...
    @Deprecated // should be handled properly in GFX instead.
    private void bindTexture(ChunkShaderTextureSlot slot, int textureId) {
        // LWJGL2/1.8.9: vanilla's GlStateManager.setActiveTexture passes the value straight to glActiveTexture(),
        // which requires the GL_TEXTURE0-relative constants (33984+). Passing raw 0/1 generated GL_INVALID_ENUM
        // (1280) every frame on the user's GL 4.2 compatibility context.
