...
public class DynamicTopoData extends DynamicData {
    ...
    public class DynamicTopoSorter extends DynamicSorter implements IntConsumer {
        ...
        // Java 8: static members are not allowed in inner classes; this is otherwise identical to the upstream static helper.
        private int getAttemptsForTime(long ns) {
        ...
        void writeSort(CombinedCameraPos cameraPos, boolean initial) {
            ...
            if (this.GFNITrigger && !this.isDirectTrigger) {
                ...
                long sortStart = initial ? 0 : System.nanoTime();
                ...
                long sortTime = initial ? 0 : System.nanoTime() - sortStart;
