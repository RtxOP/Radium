...
class InnerBinaryPartitionBSPNode extends InnerPartitionBSPNode {
    ...
    void addPartitionPlanes(BSPWorkspace workspace) {
        ...
        if (this.inside instanceof InnerPartitionBSPNode) {
            ((InnerPartitionBSPNode) this.inside).addPartitionPlanes(workspace);
        }
        if (this.outside instanceof InnerPartitionBSPNode) {
            ((InnerPartitionBSPNode) this.outside).addPartitionPlanes(workspace);
        }
    }
