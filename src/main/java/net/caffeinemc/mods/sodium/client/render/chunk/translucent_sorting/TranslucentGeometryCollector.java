...
public class TranslucentGeometryCollector {
    ...
    private SortType sortTypeHeuristic() {
        ...
        // should be attempted
        int attemptLimitIndex = MathHelper.clamp_int(normalCount, 2, STATIC_TOPO_SORT_ATTEMPT_LIMITS.length - 1);
    ...
    public TranslucentData getTranslucentData(
        ...
        if (newData instanceof PresentTranslucentData) {
            ((PresentTranslucentData) newData).setQuadHash(this.getQuadHash());
        }
        return newData;
    }
}