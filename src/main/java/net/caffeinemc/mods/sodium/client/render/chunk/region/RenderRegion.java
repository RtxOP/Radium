...
public class RenderRegion {
    ...
    @Nullable private final TileEntity[][] globalBlockEntities = new TileEntity[RenderRegion.REGION_SIZE][];
    @Nullable private final TileEntity[][] culledBlockEntities = new TileEntity[RenderRegion.REGION_SIZE][];
    @Nullable private final TextureAtlasSprite[][] animatedSprites = new TextureAtlasSprite[RenderRegion.REGION_SIZE][];
    ...
    public void clearCachedBatchFor(TerrainRenderPass pass) {
        MultiDrawBatch batch = this.cachedBatches.remove(pass);
        if (batch != null) {
            batch.clear();
        }
    }
     ...
     */
    public TileEntity[] getGlobalBlockEntities(int id) {
     ...
     * @return The collection of block entities
     */
    public TileEntity[] getCulledBlockEntities(int id) {
