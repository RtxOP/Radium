...
/**
 * MCP 1.8.9 port: {@code ChunkOcclusionData} lives in {@code net.minecraft.client.renderer.chunk}
 * and {@code isVisibleThrough(EnumFacing, EnumFacing)} already uses the MCP-facing names.
 */
