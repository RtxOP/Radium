...
public class SortTriggering {
    ...
    public void integrateTranslucentData(TranslucentData oldData, TranslucentData newData, Vector3dc cameraPos,
        ...
        if (newData instanceof DynamicData) {
            DynamicData dynamicData = (DynamicData) newData;
            ...
            if (dynamicData instanceof DynamicTopoData) {
                DynamicTopoData topoSortData = (DynamicTopoData) dynamicData;
    ...
    public void addDebugStrings(List<String> list, SortBehavior sortBehavior) {
        QuadSplittingMode splittingMode = SodiumClientMod.options().performance.quadSplittingMode;
        list.add(String.format("TS (%s,%s) NL=%02d TrN=%02d TrS=G%03d/D%03d",
                ...
                this.gfniTriggerCount,
                this.directTriggerCount));
        list.add(String.format("N=%05d SNR=%05d STA=%05d DYN=%05d (DIR=%02d)",
