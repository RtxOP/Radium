...
public final class DoubleBufferedQueue<E> {
    private QueueImpl<E> read;
    private QueueImpl<E> write;

    public DoubleBufferedQueue() {
        this.read = new QueueImpl<E>();
        this.write = new QueueImpl<E>();
    }
    ...
    private static final class QueueImpl<E> implements ReadQueue<E>, WriteQueue<E> {
        ...
        private static int getNextSize(int current, int desired) {
            if (desired == 0) {
