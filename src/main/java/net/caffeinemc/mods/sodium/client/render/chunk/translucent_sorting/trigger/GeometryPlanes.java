...
public class GeometryPlanes {
    ...
    public void addUnalignedPlane(SectionPos sectionPos, Vector3fc normal, float distance) {
        ...
        Vector3fc cleanedNormal = this.cleanNormal(normal);
        NormalPlanes normalPlanes = unalignedDistances.get(cleanedNormal);
    ...
    public Object2ReferenceMap<Vector3fc, float[]> prepareAndGetDistances() {
        Object2ReferenceOpenHashMap<Vector3fc, float[]> distancesByNormal = new Object2ReferenceOpenHashMap<Vector3fc, float[]>(10);
